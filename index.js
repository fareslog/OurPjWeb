document.addEventListener('DOMContentLoaded', () => {
  ...
  const player1_name = document.getElementById('player')
  ...
  const player2 = document.getElementById('player2')
    ...
    let cols, rows, steps, counter = 0
        ...
        let drawField = () => {
            ...
            box.setAttribute('class', 'container d-flex flex-column mx-auto  my-auto ')
            ...
            for (let i = 0; i < rows; i++) {
                ...
                for (let j = 0; j < cols; j++) {
                    ...
                    cell.className = 'cell bg-light border rounded-lg shadow-sm text-primary p-3  '
                    cell.style.width =
                        cell.style.height =
        ...
        let handleStart = () => {
            ...
            player2.innerHTML = player2_name.value === '' ? 'Player \'O\'' : player2_name
            cols = checkInput(document.getElementById('txt').value)
            rows = checkInput(document.getElementById('txt').value)
        ...
        let isWinning = (y, x) => {
            ...
            let emptyCells = []
                ...
                let [randomY, randomX] = emptyCells[randomIndex]
                
                
                gameState[randomY][randomX] = 'O'
                
                
                updateUI(randomY, randomX, 'O')
                
            
                if (isWinning(randomY, randomX)) {
                    return
                }
            ...
            let handleRestart = () => {
                ...
                statusDisplay.style.color = 'black'
                player1.style.background = player2.style.background = '#d0bdf4'
                player1_name.value = player2_name = ''
